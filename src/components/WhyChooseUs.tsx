...
interface Perk {
  perkLogo: React.ComponentType<{ className?: string; 'aria-hidden'?: boolean }>;
  perkDesc: string;
}
 ...
 */
const WhyChooseUs: React.FC<WhyChooseUsProps> = ({ consistentLayout, whyChooseUS }) => {
  ...
  return (
    ...
    >
      <div className="text-c4-0 space-y-10">
        ...
        <div className="grid grid-cols-2 max-md:flex max-md:flex-col gap-8 xl:px-[200px] lg:px-[96px]">
          <div className="flex items-center justify-center">
            <Image 
              src={img} 
              alt="Image of our website scores" 
              className='w-full h-fit max-md:max-h-[360px] max-md:max-w-[360px] rounded-lg'
              width={600}
              height={400}
            />
          </div>
