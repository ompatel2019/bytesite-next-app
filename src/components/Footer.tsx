...
const Footer: React.FC<FooterProps> = ({ consistentLayout }) => {
  const socials = [
    {
  ...
  return (
    ...
    >
      <div className="md:space-y-8 border-b-2 md:pb-10 pb-4">
        ...
        <h2 className="h2 w-full text-center font-bold xl:tracking-[40px] lg:tracking-[32px] md:tracking-[24px] max-md:hidden">
          BYTESITE DIGITAL
        </h2>
      </div>
