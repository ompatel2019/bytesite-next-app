...
interface Blog {
  blogImage: any; // Using any for now since these are imported images
  blogType: string;
  blogTitle: string;
  blogDescription: string;
  blogReleaseDuration: string;
  blogTo: string;
}

const Blogs: React.FC<BlogsProps> = ({consistentLayout, blogsSec}) => {
